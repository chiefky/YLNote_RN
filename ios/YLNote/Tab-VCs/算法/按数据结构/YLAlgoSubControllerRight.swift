...
class YLAlgoSubRightDataManager: YLQuestionDataManagerBase {
    override var jsonFileName: String {
        return "AlgoRight"
    }
    override var headerIdentifier: String {
        return "YLAlgoSubControllerRight.cell"
    }
    
    override var cellIdentifier: String {
        return "YLAlgoSubControllerRight.header"
    }
    
}


class YLAlgoSubControllerRight: UIViewController {
    ...
    lazy var dataManager: YLAlgoSubRightDataManager = {
        let mana = YLAlgoSubRightDataManager()
        return mana
    }()
