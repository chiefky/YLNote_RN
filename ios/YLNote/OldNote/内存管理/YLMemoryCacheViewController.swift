//
//  YLMemoryCacheViewController.swift
//  YLNote
//
...
class YLMemoryCacheViewController: UIViewController {
    ...
    extension YLMemoryCacheViewController: UITableViewDataSource,UITableViewDelegate {
